...
import styles from "./managePathologyList.module.css";
...
const columns = [
  ...
  { Header: "Pathology Name", accessor: "PathoName" },
  { Header: "Clinic Name", accessor: "ClinicName" },
  { Header: "City", accessor: "City" },
  { Header: "Phone Number", accessor: "phoneNumber" },
];

const ManagePathologyList = () => {
  ...
  const [PathoName, setPathoName] = useState(field);
  ...
  const onTextChange = (field, value) => {
    switch (field) {
      case "Pathology Name":
        setPathoName(anythingExceptOnlySpace(field, value));
        break;
  ...
  return (
    <div style={{ marginBottom: "10px" }}>
      <div>
        <ComponentConstant.HeaderBar TitleName={"Manage Pathology List"} />
      </div>
      <div
        style={{
          height: "50px",
      ...
      >
        <div className={styles.clinicFromContainer}>
          ...
          <div style={{ textAlign: "center", margin: "0px 0px 50px" }}>
            <p style={{ color: "var(--Color10)" }}>Pathology Details</p>
          </div>
          <div style={{ display: "flex", justifyContent: "center" }}>
            <ComponentConstant.InputBox
              InputTitle={"Pathology Name"}
              placeholder={"Enter Employee Name"}
              required={true}
              errormsg={PathoName?.errorField}
              value={PathoName?.fieldValue}
              onChange={(e) => onTextChange("Pathology Name", e.target.value)}
            />
          </div>
          <div style={{ display: "flex", justifyContent: "center" }}>
            <ComponentConstant.InputBox
              InputTitle={"Pathology Phone Number"}
...
export default ManagePathologyList;
