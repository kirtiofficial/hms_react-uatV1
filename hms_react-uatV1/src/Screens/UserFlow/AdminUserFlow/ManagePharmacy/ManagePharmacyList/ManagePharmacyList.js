...
import styles from "./ManagePharmacyList.module.css";
...
const columns = [
  ...
  { Header: "Pharmacy Name", accessor: "PharmaName" },
  { Header: "Clinic Name", accessor: "ClinicName" },
  { Header: "City", accessor: "City" },
  { Header: "Phone Number", accessor: "phoneNumber" },
];

const ManagePharmacyList = () => {
  ...
  const [PharmaName, setPharmaName] = useState(field);
  const [pharmaCity, setPharmaCity] = useState();
  const [pharmaClinic, setPharmaClinic] = useState();
  const [PharmaNumber, setPharmaNumber] = useState(field);
  ...
  const onTextChange = (field, value) => {
    switch (field) {
      case "Pharmacy Name":
        setPharmaName(anythingExceptOnlySpace(field, value));
        break;
      case "Pharmacy Phone Number":
        setPharmaNumber(onlyNumber(field, value));
        break;
      // case "Clinic Address":
  ...
  return (
    <div style={{ marginBottom: "10px" }}>
      <div>
        <ComponentConstant.HeaderBar TitleName={"Manage Pharmacy List"} />
      </div>
      <div
        style={{
          height: "50px",
      ...
      >
        {/* <button
                    onClick={() => {
                        navigate("/admin-dashboard/manage-pharmacy-list");
                    }}
      ...
      >
        <div className={styles.clinicFromContainer}>
          ...
          <div style={{ textAlign: "center", margin: "0px 0px 50px" }}>
            <p style={{ color: "var(--Color10)" }}>Pharmacy Details</p>
          </div>
          <div style={{ display: "flex", justifyContent: "center" }}>
            <ComponentConstant.InputBox
              InputTitle={"Pharmacy Name"}
              placeholder={"Enter Employee Name"}
              required={true}
              errormsg={PharmaName?.errorField}
              value={PharmaName?.fieldValue}
              onChange={(e) => onTextChange("Pharmacy Name", e.target.value)}
            />
          </div>
          <div style={{ display: "flex", justifyContent: "center" }}>
            <ComponentConstant.InputBox
              InputTitle={"Pharmacy Phone Number"}
              placeholder={"Enter Phone Number"}
              required={true}
              errormsg={PharmaNumber?.errorField}
              value={PharmaNumber?.fieldValue}
              onChange={(e) =>
                onTextChange("Pharmacy Phone Number", e.target.value)
              }
            />
          </div>
          <div style={{ display: "flex", justifyContent: "center" }}>
            <ComponentConstant.SelectPickerBox
              ...
              data={cityList}
              onChange={(e) => setPharmaCity(JSON.parse(e.target.value))}
            />
          </div>
          <div style={{ display: "flex", justifyContent: "center" }}>
            <ComponentConstant.SelectPickerBox
              ...
              data={ClinicList}
              onChange={(e) => setPharmaClinic(JSON.parse(e.target.value))}
            />
          </div>
          <div
            style={{
...
export default ManagePharmacyList;
