...
import styles from "./ManagePharmacyEmployee.module.css";
...
const ManagePharmacyEmployee = () => {
  ...
  return (
    <div style={{ marginBottom: "10px" }}>
      <div>
        <ComponentConstant.HeaderBar TitleName={"Manage Pharmacy Employee"} />
      </div>
      <div
        style={{
          height: "50px",
...
export default ManagePharmacyEmployee;
